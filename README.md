...
- **Edge Reverse Proxy**: `/api/*` rewrites directly to the centralized CMS backend API (`https://blogary.jupsoft.com/v1/:path*`).
...
|---|---|---|
| `CMS_API_URL` | `https://blogary.jupsoft.com` | Centralized CMS Backend API URL |
| `NEXT_PUBLIC_CMS_API_URL` | `https://blogary.jupsoft.com` | Client-side CMS Backend URL |
| `CMS_WEBSITE_ID` | `site-growth` | Website identifier registered in CMS |
| `NEXT_PUBLIC_CMS_WEBSITE_ID` | `site-growth` | Client-side website identifier |
| `CMS_TENANT_API_KEY` | `digi_live_sec_growth_8821ecde71a209` | Tenant live secret API key |
| `CMS_API_KEY` | `digi_live_sec_growth_8821ecde71a209` | API Key alias |
| `SITE_DOMAIN` | `https://digifynext.com` | Canonical domain for the website |
| `NEXT_PUBLIC_SITE_DOMAIN` | `https://digifynext.com` | Public domain for OpenGraph / JSON-LD |
